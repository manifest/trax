...
class LSHFF(base.Layer):
  ...
  def forward(self, x):
    ...
    hash_mask = np.minimum(np.sum(hash_mask, axis=0), 1)  # 1 if any equal
    hash_mask = hash_mask.astype(np.float32)
